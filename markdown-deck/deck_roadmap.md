...
- [ ] Syntax highlighting for code blocks (keyword coloring by language)
...
- [ ] Diagram support (simple flowcharts/boxes via ASCII or custom syntax)
...
- [ ] Presenter view (current slide + next slide + speaker notes + timer)
